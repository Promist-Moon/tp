 ...
 * outside of the {@code ViewCommand} For example, inputs "1" and "1 abc" take the
...
public class ViewCommandParserTest {
    ...
    @Test
    public void parse_invalidNegativeArgs_throwsParseException() {
        assertParseFailure(parser, "-2", String.format(MESSAGE_INVALID_COMMAND_FORMAT, ViewCommand.MESSAGE_USAGE));
    }
}
